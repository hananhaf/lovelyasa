...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangku","Semangat terus nggih Kuliah nyaaa Aku ada pertanyaan nih buat kamu yangg", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("Awas wae nek kamu bohong", "", "error").then(function () {
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuu iyaaa ${sender} juga kangen ${nama} , makasihhh yaa byyy`).then(function () {
                          Swal.fire('Terakhir byyy sayang').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah dong')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('yahhh , emang ga kangen sama bojo sendiri', '', 'error').then(function () {
                          Swal.fire('Yaudah deh okee sayangg :(( aku sedih')
                        })
                      }
                    })
                  })
